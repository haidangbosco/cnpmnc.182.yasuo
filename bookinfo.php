    ...
    <div class="card mt-0 p-4">
			<div class="wrapper row">
				...
				<div class="details col-md-6">
                    ...
                    <div><h5>Category</h5><?php echo $book["type"] ?></div>
					<div class="action">
						<a href="./userprofile.php?id=<?php echo $author['id']?>"><button class="add-to-cart btn btn-default" type="button">Mượn</button></a>
					</div>
				</div>
			</div>
		</div>
